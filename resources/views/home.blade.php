                ...
                <div class="col-lg-9">
                    <div class="ps-lg-3 ps-xl-0">
                        ...
                        <div class="border-bottom py-4">
                            ...
                            <form action="#" method="post" class="row g-3 g-sm-4 needs-validation" novalidate>
                                <div class="col-sm-6">
                                    <label for="fn" class="form-label">Họ và tên</label>
                                    <div class="position-relative">
                                        <input type="text" class="form-control" id="name" name="name" value="Susan"
                                            required />
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="password-toggle">
                                        <input type="password" class="form-control" id="current-password"
                                            name="current-password" placeholder="Nhập mật khẩu hiện tại của bạn" required />
