...
@section('content')
    ...
    <main class="content-wrapper">
        ...
        <h1 class="h3 container mb-4">Tất cả tin tức</h1>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 gy-5">
                        ...
                        <article class="col">
                            <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="#"
                                ...
                                <img src="assets/img/blog/05.jpg" class="hover-effect-target" alt="Image" />
                            </a>
                            <div class="pt-4">
                                ...
                                <h3 class="h5 mb-0">
                                    <a class="hover-effect-underline"
                                        href="">Optimizing your workspace: The guide
                                        to an
                                        efficient and minimalist desk setup</a>
                                </h3>
                            </div>
                        </article>
                        <!-- Article -->
                        <article class="col">
                            <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="#"
                                style="--cz-aspect-ratio:calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/06.jpg" class="hover-effect-target" alt="Image" />
                            </a>
                            <div class="pt-4">
                                <div class="nav align-items-center gap-2 pb-2 mt-n1 mb-1">
                                ...
                                <h3 class="h5 mb-0">
                                    <a class="hover-effect-underline" href="#">Exploring the skies: The rise of drone
                        ...
                        <article class="col">
                            <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="#"
                                style="--cz-aspect-ratio:calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/07.jpg" class="hover-effect-target" alt="Image" />
                            </a>
                            <div class="pt-4">
                                <div class="nav align-items-center gap-2 pb-2 mt-n1 mb-1">
                                ...
                                <h3 class="h5 mb-0">
                                    <a class="hover-effect-underline" href="#">Connecting the dots: How IoT technology is
                                        transforming everyday life</a>
                                </h3>
                            </div>
                        </article>
                        <!-- Article -->
                        <article class="col">
                            <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="#"
                                style="--cz-aspect-ratio:calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/08.jpg" class="hover-effect-target" alt="Image" />
                            </a>
                            <div class="pt-4">
                                <div class="nav align-items-center gap-2 pb-2 mt-n1 mb-1">
                                ...
                                <h3 class="h5 mb-0">
                                    <a class="hover-effect-underline" href="#">How to find the best deals and make secure
                                        transactions online</a>
                                </h3>
                            </div>
                        </article>
                        <!-- Article -->
                        <article class="col">
                            <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="#"
                                style="--cz-aspect-ratio:calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/09.jpg" class="hover-effect-target" alt="Image" />
                            </a>
                            <div class="pt-4">
                                <div class="nav align-items-center gap-2 pb-2 mt-n1 mb-1">
                                ...
                                <h3 class="h5 mb-0">
                                    <a class="hover-effect-underline" href="#">Top 10 electric kitchen appliances for modern
                                        homes</a>
                                </h3>
                            </div>
                        </article>
                        ...
                        <article class="col">
                            <a class="ratio d-flex hover-effect-scale rounded overflow-hidden" href="#"
                                style="--cz-aspect-ratio:calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/10.jpg" class="hover-effect-target" alt="Image" />
                            </a>
                            <div class="pt-4">
                                <div class="nav align-items-center gap-2 pb-2 mt-n1 mb-1">
                                ...
                                <h3 class="h5 mb-0">
                                    <a class="hover-effect-underline" href="#">Immersive worlds: A dive into the latest VR
