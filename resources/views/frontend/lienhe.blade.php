...
@section('content')
    ...
    <main class="content-wrapper">
        <div class="container mb-4 mt-4">
            ...
            <p class="text-center pb-2 pb-sm-3">Điền vào mẫu dưới đây và chúng tôi sẽ trả lời trong vòng 24 giờ</p>
            ...
            <section class="row row-cols-1 row-cols-md-2 g-0 overflow-hidden rounded-5">
                ...
                <div class="col position-relative">
                    <img src="assets/img/cover/form-image.jpg"
                        class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover" alt="Image" />
                </div>
            </section>

            <!-- Contacts -->
            <section class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4 mt-4">
