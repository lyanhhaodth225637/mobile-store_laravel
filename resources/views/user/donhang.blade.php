                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3 d-none d-md-table-cell">
                                            <button type="button" class="btn orders-sort fw-normal text-body p-0"
                                                data-sort="date">Ngày tạo</button>
                                        </th>
                                        <th scope="col" class="py-3 d-none d-md-table-cell">
                                        ...
                                        <th scope="col" class="py-3 d-none d-md-table-cell">
                                            <button type="button" class="btn orders-sort fw-normal text-body p-0"
                                                data-sort="total">Thành tiền</button>
                                        </th>
                                    ...
                                    <tr>
                                        <td class="fw-medium pt-2 pb-3 py-md-2 ps-0">
                                            ...
                                            <ul class="list-unstyled fw-normal text-body m-0 d-md-none">
                                                ...
                                                <li class="d-flex align-items-center"><span
                                                        class="bg-info rounded-circle p-1 me-2"></span> In progress</li>
                                        ...
                                        <td class="fw-medium py-3 d-none d-md-table-cell">
                                            <span class="d-flex align-items-center"><span
                                                    class="bg-info rounded-circle p-1 me-2"></span> In progress</span>
                                        </td>
                                        <td class="fw-medium py-3 d-none d-md-table-cell">
                                    ...
                                    <tr>
                                        <td class="fw-medium pt-2 pb-3 py-md-2 ps-0">
                                            ...
                                            <ul class="list-unstyled fw-normal text-body m-0 d-md-none">
                                                <li>12/12/2024</li>
                                                <li class="d-flex align-items-center"><span
                                                        class="bg-success rounded-circle p-1 me-2"></span> Delivered</li>
                                        ...
                                        <td class="fw-medium py-3 d-none d-md-table-cell">
                                            <span class="d-flex align-items-center"><span
                                                    class="bg-success rounded-circle p-1 me-2"></span> Delivered</span>
                                        </td>
                                        <td class="fw-medium py-3 d-none d-md-table-cell">
                                    ...
                                    <tr>
                                        <td class="fw-medium pt-2 pb-3 py-md-2 ps-0">
                                            ...
                                            <ul class="list-unstyled fw-normal text-body m-0 d-md-none">
                                                <li>15/09/2024</li>
                                                <li class="d-flex align-items-center"><span
                                                        class="bg-danger rounded-circle p-1 me-2"></span> Canceled</li>
                                        ...
                                        <td class="fw-medium py-3 d-none d-md-table-cell">
                                            <span class="d-flex align-items-center"><span
                                                    class="bg-danger rounded-circle p-1 me-2"></span> Canceled</span>
                                        </td>
                                        <td class="fw-medium py-3 d-none d-md-table-cell">
            ...
            <div class="offcanvas-body d-flex flex-column gap-4 pt-2 pb-3">
                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            <h5 class="d-flex animate-underline mb-2">
                                <a class="d-block fs-sm fw-medium text-truncate animate-target" href="#">Smart Watch Series
                                    7, White</a>
                            </h5>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            <h5 class="d-flex animate-underline mb-2">
                                <a class="d-block fs-sm fw-medium text-truncate animate-target" href="#">Apple iPhone 14
                                    128GB White</a>
                            </h5>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            <h5 class="d-flex animate-underline mb-2">
                                <a class="d-block fs-sm fw-medium text-truncate animate-target" href="#">Tablet Apple iPad
                                    Pro M2</a>
                            </h5>
