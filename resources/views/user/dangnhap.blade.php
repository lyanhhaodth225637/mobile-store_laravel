...
1.935 1.94 1.94 0 0 1-1.936-1.935 1.94 1.94 0 0 1 1.936-1.935 1.94 1.94 0 0 1 1.936 1.935z" />
                ...
                <div class="nav fs-sm mb-4">
                    ...
                    <a class="nav-link text-decoration-underline p-0 ms-2" href="{{ route('user.dangky') }}">Tạo một tài
                        khoản</a>
                </div>
                ...
                <form method="post" action="{{ route('login') }}" class="needs-validation" novalidate>
                    ...
                    <div class="position-relative mb-4">
                        <input type="text"
                            ...
                            placeholder="Email, Tên đăng nhập hoặc Điện thoại" required />
                    ...
                    <div class="mb-4">
                        <div class="password-toggle">
                            <input type="password"
                                ...
                                id="password" name="password" autocomplete="current-password" placeholder="Mật khẩu"
                                required />
