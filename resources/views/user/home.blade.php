...
@section('content')
                ...
                <div class="col-lg-9">
                    ...
                    <div class="offcanvas-header d-lg-block py-3 p-lg-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="position-relative">
                                <img src="{{ asset('storage/' . Auth::user()->hinhanh) }}" id="avatarPreview"
                                    class="rounded-circle"
                                    style="object-fit: cover; width: 100px; height: 100px; cursor: pointer;" alt="Avatar"
                                ...
                                <div class="position-absolute bottom-0 end-0 bg-primary rounded-circle d-flex align-items-center justify-content-center"
                                    ...
                                    onclick="document.getElementById('avatarInput').click()">
                                    <i class="ci-camera text-white fs-sm"></i>
                                </div>

                                <!-- Hidden file input -->
                                <form id="avatarForm" action="{{ route('user.upload.avatar') }}" method="POST"
                            ...
                            <div class="min-w-0 ps-3">
                                <h5 class="h4 mb-0">{{ $user->name }}</h5>
                                <div class="nav flex-nowrap text-nowrap min-w-0">
                                    <a class="nav-link animate-underline text-body p-0" href="{{ route('user.home') }}">
                                        <svg class="text-warning flex-shrink-0 me-1" xmlns="http://www.w3.org/2000/svg"
                                            width="16" height="16" fill="currentColor">
                                            <path d="M1.333 9.667H7.5V16h-5c-.64 0-1.167-.527-1.167-1.167V9.667zm13.334 0v5.167c0 .64-.527 1.167-1.167 1.167h-5V9.667h6.167zM0 
                                                                                    5.833V7.5c0 .64.527 1.167 1.167 1.167h.167H7.5v-1-3H1.167C.527 4.667 0 5.193 0 5.833zm14.833-1.166H8.5v3 1h6.167.167C15.473 8.667 16 8.14 16 7.5V5.833c0-
                                                                                    .64-.527-1.167-1.167-1.167z" />
                                            <path
                                                d="M8 5.363a.5.5 0 0 1-.495-.573C7.752 3.123 9.054-.03 12.219-.03c1.807.001 2.447.977 2.447 1.813 0 1.486-2.069 3.58-
                                                                                         6.667 3.58zM12.219.971c-2.388 0-3.295 2.27-3.595 3.377 1.884-.088 3.072-.565 3.756-.971.949-.563 1.287-1.193 1.287-1.595 0-.599-.747-.811-1.447-.811z" />
                                            <path
                                                d="M8.001 5.363c-4.598 0-6.667-2.094-6.667-3.58 0-.836.641-1.812 2.448-1.812 3.165 0 4.467 3.153 4.713 4.819a.5.5 0 0 1-.495.573zM3.782.971c-.7 0-
                                                                                      1.448.213-1.448.812 0 .851 1.489 2.403 5.042 2.566C7.076 3.241 6.169.971 3.782.971z" />
                                        </svg>
                                        <span class="text-body fw-normal text-truncate mt-1">Điểm tích lỹ:
                                            {{ $user->points }} điểm</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <button type="button" class="btn-close d-lg-none" data-bs-dismiss="offcanvas"
                            data-bs-target="#accountSidebar"></button>
                    </div>
                    <div class="ps-lg-3 ps-xl-0">
                        ...
                        <div class="border-bottom py-4">
                            ...
                            <form action="{{ route('user.hoso') }}" method="post" class="row g-3 g-sm-4 needs-validation"
                                novalidate>
                                @csrf
                                <div class="col-sm-6">
                        ...
                        <div class="border-bottom py-4">
                            ...
                            <form action="{{ route('user.doimatkhau') }}" method="post"
                                class="row g-3 g-sm-4 needs-validation" novalidate>
                                @csrf
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="password-toggle">
                                        <input type="password"
                                            ...
                                            id="new-password" name="new_password" placeholder="Nhập mật khẩu mới"
                                            required />
                                        <label class="password-toggle-button">
                                            <input type="checkbox" class="btn-check" />
                                        </label>
                        ...
                        <div class="pt-3 mt-2 mt-sm-3">
                            ...
                            <p class="fs-sm">Khi bạn xóa tài khoản, hồ sơ công khai của bạn sẽ bị vô hiệu hóa ngay lập tức.
                                Nếu bạn đổi ý trước khi hết 14 ngày, hãy đăng nhập bằng email và mật khẩu, chúng tôi sẽ gửi
                                cho bạn liên kết để kích hoạt lại tài khoản.</p>
    ...
    <!-- JavaScript for avatar preview and upload -->
    <script>
